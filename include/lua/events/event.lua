...
if (tfm.get.room.uniquePlayers < module.minPlayers or tfm.get.room.uniquePlayers > module.maxPlayers) then
	return system.exit()
end
...
do
	local translations = {
		en = {
			credits = "\n\n<p align='center'><font size='-1'>Event by <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, amazing art by <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		br = {
			credits = "\n\n<p align='center'><font size='-1'>Evento por <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, arte incrível por <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		es = {
			credits = "\n\n<p align='center'><font size='-1'>Evento por <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, arte asombroso por <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		cn = {
			credits = "\n\n<p align='center'><font size='-1'>活動製作: <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, 驚世藝術繪畫: <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		it = {
			credits = "\n\n<p align='center'><font size='-1'>Evento creato da <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, incredibili disegni di <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		hu = {
			credits = "\n\n<p align='center'><font size='-1'>Az Eventet <FC>Lucas</FC><font size='-3'><G>#0015</G></font> készítette, a gyönyörű rajzot pedig <FC>Furianera</FC><font size='-3'><G>#0506</G></font> készítette.</font></p>",
		...
		tr = {
			credits = "\n\n<p align='center'><font size='-1'>Etkinliği yapan: <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, inanılmaz resimleri yapan: <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
		...
		fr = {
			credits = "\n\n<p align='center'><font size='-1'>Event par <FC>Lucas</FC><font size='-3'><G>#0015</G></font>, incroyable art par <FC>Furianera</FC><font size='-3'><G>#0506</G></font>.</font></p>",
